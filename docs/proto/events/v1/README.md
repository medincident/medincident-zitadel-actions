...
- [events/v1/envelope.proto](#events_v1_envelope-proto)
    - [Envelope](#events-v1-Envelope)

- [Scalar Value Types](#scalar-value-types)



<a name="events_v1_envelope-proto"></a>
